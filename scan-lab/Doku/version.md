...
- Viewer: Die neue Mittelgruppe ist fuer weitere XY/XZ/YZ-Ausrichtungsbuttons vorbereitet.
...
## 0.7.0 (2026-03-28)
- Projektversion auf `0.7.0` erhoeht.
- Viewer: Ausklappbares Controls-Dock auf der rechten Seite fuer Model color, Lighting profile und Viewer size hinzugefuegt.
- Viewer: Ausklappbares Models-Dock auf der linken Seite fuer Detected sample models hinzugefuegt.
...
- Projektversion auf `0.3.12` erhoeht.
